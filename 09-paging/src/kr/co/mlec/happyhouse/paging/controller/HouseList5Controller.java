...
@WebServlet("/house/list5")
public class HouseList5Controller extends HttpServlet {
	private HouseService service;
	public HouseList5Controller() {
	...
	public void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			request.getRequestDispatcher("/jsp/house/list5.jsp").forward(request, response);
		} catch (Exception e) {
			e.printStackTrace();
