      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="myNavbar">
          ...
          <ul class="nav navbar-nav navbar-right">
            <li><button type="button" class="btn btn-warning" style="margin-top: 10px; margin-right: 10px;" id="login">로그인</button></li>
            <li><button type="button" class="btn btn-warning" style="margin-top: 10px; margin-right: 10px; display: none;"id = "logout">로그아웃</button></li>
            <li><button type="button" class="btn btn-warning" style="margin-top: 10px; margin-right: 10px;" id="reg">회원가입</button></li>
            <li><button type="button" class="btn btn-warning" style="margin-top: 10px; margin-right: 10px; display: none;" id = "myInfo">마이페이지</button></li>
          </ul>
        </div>
      </div>
    </nav>
