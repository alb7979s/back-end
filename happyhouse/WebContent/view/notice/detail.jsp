...
<body id="myPage" data-spy="scroll" data-target=".navbar"
	...
	<div class="container menu" id="makeBoard"
		...
		<form action="" id="updateform">
			<input id = "hiddeninput"type="hidden" name = "cnt" value="">
	...
	deleteBtn.addEventListener('click',function(){
		location.href="${root}/notice?act=delete&number=${notice.noticeno}"
	});
	...
	updateBtn.addEventListener('click',function(){
		location.href="${root}/notice?act=mvmodify&number=${notice.noticeno}";
	});
